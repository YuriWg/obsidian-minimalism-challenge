class MinimalismChallenge {
    ...
    initializeElements() {
        ...
        this.statusElement = document.getElementById('challengeStatus');
    ...
    renderItems() {
        ...
        this.items.forEach((item, index) => {
            ...
            li.innerHTML = `
                <span>${item}</span>
                <button onclick="challenge.removeItem(${index})">删除</button>
            `;
...
const challenge = new MinimalismChallenge();